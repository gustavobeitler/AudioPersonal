...
public final class HeadphoneProfileRepositoryV04 {
    ...
    private HeadphoneProfileRepositoryV04() { }
    ...
    private static String downloadText(String address) throws Exception {
        ...
        connection.setRequestProperty("User-Agent", "RadioEnlaceAudio/0.4");
